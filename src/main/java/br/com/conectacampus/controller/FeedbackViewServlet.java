...
public class FeedbackViewServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (!Autorizacao.podeVisualizarFeedbacks(usuarioLogado)) {
		...
		case "listar":
			...
			request.getRequestDispatcher("/pages/feedbackView.jsp").forward(request, response);
		...
		case "visualizar":
			...
			request.getRequestDispatcher("/pages/detalheFeedbackView.jsp").forward(request, response);
		...
		case "excluir":
			...
			boolean excluiu = feedbackViewService.excluir(Integer.parseInt(request.getParameter("id")));
