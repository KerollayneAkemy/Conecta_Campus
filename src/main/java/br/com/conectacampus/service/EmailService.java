...
public class EmailService {
    ...
    private int porta() {
        try { return Integer.parseInt(valorOuPadrao(configuracao("SMTP_PORT"), "465")); }
        catch (NumberFormatException e) { return 465; }
    }
    ...
    private InetAddress enderecoIpv4(String host) throws IOException {
        ...
        throw new IOException("Ṇo foi encontrado um endere̤o IPv4 para " + host + ".");
    }
}
