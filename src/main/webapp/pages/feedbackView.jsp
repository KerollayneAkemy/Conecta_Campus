...
<div class="page-header">
    <div>
        ...
        <h1 class="page-title"><i class="bi bi-eye-fill" aria-hidden="true"></i> Visualizar Feedbacks</h1>
        <p class="page-subtitle">Acompanhe sugestões, elogios e reclamações enviados pela comunidade.</p>
    </div>
</div>

<div class="row g-3 mb-4">
    <div class="col-md-3">
        <a class="text-decoration-none" href="${pageContext.request.contextPath}/feedbackview?acao=listar">
            <div class="card metric-card">
                <div class="card-body">
                    ...
                    <span class="metric-icon"><i class="bi bi-envelope-fill" aria-hidden="true"></i></span>
                </div>
            </div>
        </a>
    </div>
    <div class="col-md-3">
        <a class="text-decoration-none" href="${pageContext.request.contextPath}/feedbackview?acao=listar&tipo=SUGESTAO">
            <div class="card metric-card">
                <div class="card-body">
                    <div>
                    ...
                    <span class="metric-icon"><i class="bi bi-lightbulb-fill" aria-hidden="true"></i></span>
                </div>
            </div>
        </a>
    </div>
    <div class="col-md-3">
        <a class="text-decoration-none" href="${pageContext.request.contextPath}/feedbackview?acao=listar&tipo=ELOGIO">
            <div class="card metric-card">
                <div class="card-body">
                    <div>
                    ...
                    <span class="metric-icon"><i class="bi bi-hand-thumbs-up-fill" aria-hidden="true"></i></span>
                </div>
            </div>
        </a>
    </div>
    <div class="col-md-3">
        <a class="text-decoration-none" href="${pageContext.request.contextPath}/feedbackview?acao=listar&tipo=RECLAMACAO">
            <div class="card metric-card">
                <div class="card-body">
                    <div>
...
<div class="card">
    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-3">
        <span>
            ...
            <span class="badge bg-secondary ms-2">Filtro: <%=filtroTipo%></span>
            <a href="${pageContext.request.contextPath}/feedbackview?acao=listar" class="ms-2" style="font-size:.8rem;">(limpar filtro)</a>
            <% } %>
        </span>
        <label class="visually-hidden" for="pesquisa">Pesquisar feedback</label>
        <input id="pesquisa" class="form-control search-input" type="search" placeholder="Pesquisar..." aria-describedby="ajudaPesquisa">
        <span id="ajudaPesquisa" class="visually-hidden">Digite para filtrar a lista de feedbacks exibida na tabela.</span>
    </div>
        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr class="feedback-row">
                    ...
                    <td>
                        <% if (f.isAnonimo()) { %>
                            <span class="text-muted"><i class="bi bi-incognito me-1" aria-hidden="true"></i>Anônimo</span>
