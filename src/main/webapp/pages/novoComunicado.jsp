...
<div class="page-header">
	<div>
		...
		<h1 class="page-title">
			<i class="bi bi-megaphone-fill" aria-hidden="true"></i> Novo
			comunicado
		</h1>
		<p class="page-subtitle">Crie um aviso claro para a comunidade
			acadêmica.</p>
	</div>
...
<div class="card">
	<div class="card-body">
		<form action="${pageContext.request.contextPath}/comunicados"
			...
			<div class="mb-3">
				<label class="form-label" for="imagem">Imagem da notícia <span
					class="text-muted fw-normal">(opcional)</span></label> <input
					class="form-control" id="imagem" name="imagem" type="file"
					accept="image/jpeg,image/png,image/gif,image/webp">
				<div class="form-text">JPG, PNG, GIF ou WEBP; máximo de 3 MB.</div>
			</div>

			<div class="row g-3">
				<div class="col-md-6">
					<label class="form-label" for="categoria">Categoria</label> <select
						id="categoria" name="idCategoria" class="form-select" required>
					...
					<% if (categorias == null || categorias.isEmpty()) { %>
					<div class="form-text text-danger">Nenhuma categoria
						encontrada no banco. Cadastre categorias antes de publicar
						comunicados.</div>
					<% } %>
				</div>
				<div class="col-md-6">
					<label class="form-label" for="prioridade">Prioridade</label> <select
						id="prioridade" name="prioridade" class="form-select">
