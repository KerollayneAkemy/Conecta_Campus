	...
	<div class="col-lg-7">
		<div class="card">
			<div class="card-header">
				<i class="bi bi-pencil-square" aria-hidden="true"></i> Dados do
				cargo
			</div>
			<div class="card-body">
				<form method="post"
					...
					<div class="mb-3">
						<label for="nome" class="form-label">Nome do cargo <span
							...
							class="form-control" id="nome" name="nome" value="<%=nomeAtual%>"
		...
		<div class="card">
			<div class="card-body">
				<span class="metric-icon mb-3"><i
					class="bi bi-info-circle-fill" aria-hidden="true"></i></span>
				<h3 class="h5">Dica</h3>
				<p class="page-subtitle mb-0">O nome do cargo deve ser único e
					claro (ex: "Professor", "Coordenador de Curso"). A descrição é
					opcional, mas ajuda a documentar as permissões e responsabilidades
					associadas.</p>
			</div>
		</div>
	</div>
