...
<div class="page-header">
    <div>
        ...
        <h1 class="page-title"><i class="bi bi-briefcase-fill" aria-hidden="true"></i> Cargos</h1>
        <p class="page-subtitle">Gerencie os cargos cadastrados na plataforma.</p>
    </div>
    <a href="${pageContext.request.contextPath}/pages/cadastroCargo.jsp" class="btn btn-primary">
        <i class="bi bi-plus-lg" aria-hidden="true"></i> Novo cargo
    </a>
</div>
    ...
    <div class="col-md-4">
        <div class="card metric-card">
            <div class="card-body">
                ...
                <span class="metric-icon"><i class="bi bi-briefcase-fill" aria-hidden="true"></i></span>
            </div>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-3">
        ...
        <label class="visually-hidden" for="pesquisa">Pesquisar cargo</label>
        <input id="pesquisa" class="form-control search-input" type="search" placeholder="Pesquisar..." aria-describedby="ajudaPesquisa">
        <span id="ajudaPesquisa" class="visually-hidden">Digite para filtrar a lista de cargos exibida na tabela.</span>
    </div>
